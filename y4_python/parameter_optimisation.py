...
if __name__ == "__main__":
    ...
    mini_args = (db, fixed_hyperparams)

    solver = differential_evolution(optimise_func,bounds=bounds,args=mini_args,popsize=10,tol=0.1,polish=False,workers=num_CPU,updating='deferred',seed=None)
